...
<body>
	...
	<div class="home">
		<div class="home1">
			<div class="homep">
				<h1>Style Begins Here!</h1>
				<p>Discover fashion that fits you.From timeless classics to fresh drops – we've got your style covered.Be bold. Be you. Be unforgettable.</p>
				<h4>Glad you’re here! Let’s create your perfect look...</h4>
				<button><a href="catalogue.php">Let's Begin</a></button>
			</div>
